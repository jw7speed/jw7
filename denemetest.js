...
function chatBubbleInfo(sendInfo) {
        ...
        gf: function (a) {
            ...
            switch (c) {
                ...
                case "colors":
                    ...
                    break;
                case "extrapolation":
                    2 == a.length ? (a = K.parseInt(a[1]),null != a  && -200 <= a && 1000 >= a ? (n.A.rd.Xa(a),this.ya.gm(a),this.ba("Extrapolation set to " + a + " msec")) : this.ba("Extrapolation must be a value in miliseconds")) : this.ba("Extrapolation requires a value in milliseconds.");
                    break;
                case "handicap":
    ...
    kb.N = "<div class='choose-nickname-view'><img src=\"images/haxball.png\" /><div class='dialog'><h1>Nick sec</h1><div class='label-input'><label>Nick:</label><input data-hook='input' type='text' /></div><button data-hook='ok'>Ok</button></div></div>";
